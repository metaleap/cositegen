...
func init() {
	...
	// var n = []uint8{0x55, 0x88, 0xAA, 0xCC, 0xDD, 0xEE}
	var n = []uint8{0x44, 0x77, 0xAA, 0xCC, 0xDD, 0xEE}
	// var n1 = []uint8{0x33, 0x44, 0x55, 0x77, 0x88, 0x99}
	// var n2 = []uint8{0xAA, 0xBB, 0xCC, 0xDD, 0xEE, 0xFF}
	for _, r := range n {
		for _, g := range n {
			for _, b := range n {
